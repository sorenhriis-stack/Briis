...
--
-- This replaces the friend ratings function. It shares tasting details,
-- blind guesses and revealed wine fields, but not private cellar data,
-- bottle counts or free text notes.
